...
const ProductContentTablet = ({ product, data: { logo, couponImage } }) => {
  useEffect(() => {
    if (isBrowser) {
      document.querySelectorAll('.tab-content table').forEach(element => {
...
export default ProductContentTablet
