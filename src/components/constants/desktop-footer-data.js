...
const FooterData = () => {
  const {
    ...
    {
      logoFooter: file(relativePath: { eq: "mattressville-logo-white-slogan.png" }) {
        childImageSharp {
          gatsbyImageData(
            width:322
          )
      ...
      footerBadge: file(relativePath: { eq: "badge.png" }) {
        childImageSharp {
          gatsbyImageData(
            formats: AUTO
  ...
  return {
    topFooter: {
      ...
      badgeAltText:`Three best business excellence award 2022 badge`,
      about: {
        title: `About Us`,
