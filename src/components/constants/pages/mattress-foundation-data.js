const MattressFoundationData = () => {
  return {
    seoData: {
      title: `Mattress Foundation`,
      description: `The foundation, “box spring”, or base, is designed to prolong the life of the mattress by providing solid, stable support.`,
      ogPath: '/mattress-foundation/',
    },
    mattressGuideData: {
      mattressFoundation: {
        title: `MATTRESS FOUNDATION`,
...
export default MattressFoundationData
